...
def loguin_vigilante():
    ...
    for vig in vigilantes:
        if vig[3]==email and vig[4]==password:
            ...
            return render_template('home_vigilante.html', vigilante=vig, visitas=visitas_rej)
...
def home_vigilante():
    ...
    visitas_rej = cur.fetchall()
    mysql.connection.commit()
    return render_template('home_vigilante.html', vigilante=vigilante_sesion, visitas=visitas_rej)
...
def validar_visita():
    ...
    for vist in visitantes:
        if placa==vist[5]:
            ...
            return render_template('home_vigilante.html',visitas=visitas_rej,mensaje_error=0, vigilante=vigilante_sesion)
    ...
    return render_template('home_vigilante.html',visitas=visitas_rej, mensaje_error=1, vigilante=vigilante_sesion)
